    ...
    return (
      <div className="createPostPop">
        ...
        <div className='popWindow'>
                <div>
                    <TextField type="text" label="Title"onChange={this.onAuthorInput} value={this.state.author} name="author" id="postAuthor"></TextField>
                </div>
            <div>
            <TextField
            ...
            <div className='postBtnContainer'>
                <Button id='postBtn' onClick={this.handleSubmit} value="Submit" >Post</Button>
            </div>
        </div>
    )}
      </Popup>
